...
Hyperion is compiled against **ProjectKorra 1.13.0** and **Spigot 1.21.11** and
targets **Java 21**.
...
repository. Hyperion's `build.gradle.kts` already includes `mavenLocal()`, so
Gradle picks it up automatically.

## Prerequisites

- JDK 21
- Maven 3.8+ (only for step 1)
...
Output: `build/libs/Hyperion-1.7.3.jar`
